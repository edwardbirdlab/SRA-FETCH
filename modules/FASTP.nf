process FASTP {
    ...
    """
    fastp -i ${R[0]} -I ${R[1]} -o ${sample}_R1.fq.gz -O ${sample}_R2.fq.gz -q ${params.fastp_q} -l ${params.fastp_minlen} --json ${sample}.fastp.json --html ${sample}.fastp.html  \\
    $adapter_arg_1 \\
    $adapter_arg_2
    """
}